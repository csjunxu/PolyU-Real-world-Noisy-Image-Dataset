...
meanRAW = imread('20161221mean/meanRAW_ARW2TIF_TIF2PNG.png');
RAWGT = imread('20161221mean/RawGT_ARW2TIF_TIF2PNG.png');
meansRGB = imread('20161221mean/meansRGB_ARW2TIF_TIF2PNG.png');
...
savename = ['PSNRSSIM_meanRAW_RAWGT_meansRGB_20161221_ISO3200.mat'];
