...
mPSNR_meansRGB = mean(PSNR_meansRGBAll);
mSSIM_meansRGB = mean(SSIM_meansRGBAll);
mPSNR_meanRAW = mean(PSNR_meanRAWAll);
mSSIM_meanRAW = mean(SSIM_meanRAWAll);
mPSNR_RAWGT = mean(PSNR_RAWGTAll);
mSSIM_RAWGT = mean(SSIM_RAWGTAll);
