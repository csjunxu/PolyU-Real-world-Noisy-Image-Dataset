clear;
%% mean of raw images
Original_image_dir = '20161225/';
fpath = fullfile(Original_image_dir, '*.png');
im_dir  = dir(fpath);
im_num = length(im_dir);
meanRAW = imread('20161225mean/meanRAW_ARW2TIF_TIF2PNG.png');
RAWGT = imread('20161225mean/RawGT_ARW2TIF_TIF2PNG.png');
meansRGB = imread('20161225mean/meansRGB_ARW2TIF_TIF2PNG.png');
...
savename = ['PSNRSSIM_meanRAW_RAWGT_meansRGB_20161225_ISO100.mat'];
